      ...
      of(null)
        .pipe(
          mergeMap(() => {
            ...
            // get browser
            if (
              request.url.endsWith('/app/browser') &&
              request.method === 'GET'
            ) {
              if (browserData) {
            ...
            // get toppage
            if (
              request.url.endsWith('/app/toppage') &&
              request.method === 'GET'
            ) {
              if (topPageData) {
            ...
            // get table
            if (
              request.url.endsWith('/app/table') &&
              request.method === 'GET'
            ) {
              if (TableData) {
            ...
            // get sales
            if (
              request.url.endsWith('/app/sales') &&
              request.method === 'GET'
            ) {
              if (sales) {
            ...
            // get order
            if (
              request.url.endsWith('/app/order') &&
              request.method === 'GET'
            ) {
              if (orders) {
            ...
            // get products
            if (
              request.url.endsWith('/app/products') &&
              request.method === 'GET'
            ) {
              if (products) {
            ...
            // get instructor
            if (
              request.url.endsWith('/app/instructor') &&
              request.method === 'GET'
            ) {
              if (instructor) {
            ...
            // get instructor
            if (
              request.url.endsWith('/app/instructorlist') &&
              request.method === 'GET'
            ) {
              if (instructorList) {
                return of(
                  new HttpResponse({ status: 200, body: instructorList })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get instructor
            if (
              request.url.endsWith('/app/instructorGrid') &&
              request.method === 'GET'
            ) {
              if (instructorGrid) {
                return of(
                  new HttpResponse({ status: 200, body: instructorGrid })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get recentcourse
            if (
              request.url.endsWith('/app/recentcourse') &&
              request.method === 'GET'
            ) {
              if (recentcourse) {
                return of(
                  new HttpResponse({ status: 200, body: recentcourse })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get recentcourse
            if (
              request.url.endsWith('/app/property') &&
              request.method === 'GET'
            ) {
              if (property) {
            ...
            // get recentcourse
            if (
              request.url.endsWith('/app/feedback') &&
              request.method === 'GET'
            ) {
              if (feedback) {
            ...
            // get recentcourse
            if (
              request.url.endsWith('/app/saleproperty') &&
              request.method === 'GET'
            ) {
              if (saleproperty) {
                return of(
                  new HttpResponse({ status: 200, body: saleproperty })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get recentcourse
            if (
              request.url.endsWith('/app/rentproperty') &&
              request.method === 'GET'
            ) {
              if (rentproperty) {
                return of(
                  new HttpResponse({ status: 200, body: rentproperty })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get listingGrid
            if (
              request.url.endsWith('/app/listingGrid') &&
              request.method === 'GET'
            ) {
              if (listingGrid) {
            ...
            // add listingList
            if (
              request.url.endsWith('/app/listingList') &&
              request.method === 'GET'
            ) {
              if (listinglist) {
            ...
            // get agentlist
            if (
              request.url.endsWith('/app/agent') &&
              request.method === 'GET'
            ) {
              if (agentlistdata) {
                return of(
                  new HttpResponse({ status: 200, body: agentlistdata })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get agencylist
            if (
              request.url.endsWith('/app/agencies') &&
              request.method === 'GET'
            ) {
              if (agencies) {
            ...
            // get support tickets
            if (
              request.url.endsWith('/app/supporttickets') &&
              request.method === 'GET'
            ) {
              if (supporttickets) {
                return of(
                  new HttpResponse({ status: 200, body: supporttickets })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            if (
              request.url.endsWith('/app/ticketList') &&
              request.method === 'GET'
            ) {
              if (ticketList) {
            ...
            if (
              request.url.endsWith('/app/message') &&
              request.method === 'GET'
            ) {
              if (messages) {
            ...
            // get chatmessage list
            if (
              request.url.endsWith('/app/chatData') &&
              request.method === 'GET'
            ) {
              if (chatData) {
            ...
            // get chatmessage list
            if (
              request.url.endsWith('/app/channnellist') &&
              request.method === 'GET'
            ) {
              if (ChannelsData) {
                return of(
                  new HttpResponse({ status: 200, body: ChannelsData })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get contact list
            if (
              request.url.endsWith('/app/chatContactData') &&
              request.method === 'GET'
            ) {
              if (chatContactData) {
                return of(
                  new HttpResponse({ status: 200, body: chatContactData })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get contact list
            if (
              request.url.endsWith('/app/attachementsData') &&
              request.method === 'GET'
            ) {
              if (attachementsData) {
                return of(
                  new HttpResponse({ status: 200, body: attachementsData })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get contact list
            if (
              request.url.endsWith('/app/callsData') &&
              request.method === 'GET'
            ) {
              if (callsData) {
            ...
            // get contact list
            if (
              request.url.endsWith('/app/bookmarkData') &&
              request.method === 'GET'
            ) {
              if (bookmarkData) {
                return of(
                  new HttpResponse({ status: 200, body: bookmarkData })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get product list
            if (
              request.url.endsWith('/app/productList') &&
              request.method === 'GET'
            ) {
              if (productList) {
            ...
            if (
              request.url.endsWith('/app/customerList') &&
              request.method === 'GET'
            ) {
              if (customerList) {
                return of(
                  new HttpResponse({ status: 200, body: customerList })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get Invoice list
            if (
              request.url.endsWith('/app/invoiceList') &&
              request.method === 'GET'
            ) {
              if (invoicesList) {
                return of(
                  new HttpResponse({ status: 200, body: invoicesList })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get Seller
            if (
              request.url.endsWith('/app/sellerOverview') &&
              request.method === 'GET'
            ) {
              if (sellerOverview) {
                return of(
                  new HttpResponse({ status: 200, body: sellerOverview })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get Seller
            if (
              request.url.endsWith('/app/seller') &&
              request.method === 'GET'
            ) {
              if (sellerList) {
            ...
            // get orderList
            if (
              request.url.endsWith('/app/orderList') &&
              request.method === 'GET'
            ) {
              if (orderList) {
            ...
            // get category
            if (
              request.url.endsWith('/app/category') &&
              request.method === 'GET'
            ) {
              if (category) {
            ...
            if (
              request.url.endsWith('/app/listinglistcard') &&
              request.method === 'GET'
            ) {
              if (listinglistcard) {
                return of(
                  new HttpResponse({ status: 200, body: listinglistcard })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get realestate listing grid
            if (
              request.url.endsWith('/app/estateList') &&
              request.method === 'GET'
            ) {
              if (estateList) {
            ...
            // get earning data
            if (
              request.url.endsWith('/app/earningdata') &&
              request.method === 'GET'
            ) {
              if (earningdata) {
            ...
            // get earning card
            if (
              request.url.endsWith('/app/earningcard') &&
              request.method === 'GET'
            ) {
              if (earningcard) {
            ...
            // get subscriptions
            if (
              request.url.endsWith('/app/subscription') &&
              request.method === 'GET'
            ) {
              if (subscription) {
                return of(
                  new HttpResponse({ status: 200, body: subscription })
                );
              } else {
                return throwError({
                  status: 401,
            ...
            // get subscriptions
            if (
              request.url.endsWith('/app/cources') &&
              request.method === 'GET'
            ) {
              if (cources) {
            ...
            // get coureslist
            if (
              request.url.endsWith('/app/courseList') &&
              request.method === 'GET'
            ) {
              if (courseList) {
            ...
            // get coureslist
            if (
              request.url.endsWith('/app/courseGrid') &&
              request.method === 'GET'
            ) {
              if (courseGrid) {
