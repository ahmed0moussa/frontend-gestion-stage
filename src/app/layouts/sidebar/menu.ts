...
export const MENUSTAGIAIRES: MenuItem[] = [
  ...
  {
    id: 9,
    label: 'Accéder aux taches',
    icon: 'ph-calendar',
    link: 'accederAuTaches',
    parentId: 8,
  },
  {
    id: 10,
    label: 'soumettre des rapports ',
    icon: 'ph-calendar',
    link: 'soumitiondesrapports',
    parentId: 8,
  },
  {
    id: 11,
    label: 'Communication Encadreur',
    icon: 'ph-calendar',
    link: 'communicationEncadreur',
    parentId: 8,
  },
  {
    id: 12,
    label: 'Demande de changement de stage ',
    icon: 'ph-calendar',
    link: 'demandeDeChangement',
    parentId: 8,
  },
];
export const MENUENCADRANT: MenuItem[] = [
  ...
  },
  {
    ...
    icon: 'ph-calendar',
    link: 'planificationActivites',
    parentId: 8,
  },
  {
    id: 10,
    label: 'Communication avec administrateur et stagiaires',
    icon: 'ph-calendar',
    link: 'communicationAdminStagiaire',
    parentId: 8,
  },
  {
    id: 11,
    label: 'Suivie progrés et evaluation de stagiaire',
    icon: 'ph-calendar',
    link: 'suivieProgresEvaluation',
    parentId: 8,
  },
];
