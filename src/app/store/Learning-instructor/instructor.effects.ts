...
import {
  addinstructorgridData,
  addinstructorgridDataFailure,
  addinstructorgridDataSuccess,
  addinstructorlistData,
  addinstructorlistDataFailure,
  addinstructorlistDataSuccess,
  deleteinstructorgridData,
  deleteinstructorgridFailure,
  deleteinstructorgriduccess,
  deleteinstructorlistData,
  deleteinstructorlistFailure,
  ...
  updateinstructorgridDataFailure,
  updateinstructorgridDataSuccess,
  updateinstructorlistData,
  updateinstructorlistDataFailure,
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.CrudService.fetchData('/app/instructorlist').pipe(
          map((instructorlist) =>
            fetchinstructorListSuccess({ instructorlist })
          ),

          catchError((error) => of(fetchinstructorListFailure({ error })))
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.CrudService.fetchData('/app/instructorGrid').pipe(
          map((instructorGrid) =>
            fetchinstructorgriduccess({ instructorGrid })
          ),
    ...
    this.actions$.pipe(
      ...
      mergeMap(({ id }) =>
        this.CrudService.deleteData('/app/instructorGrid').pipe(
          map(() => deleteinstructorgriduccess({ id })),
