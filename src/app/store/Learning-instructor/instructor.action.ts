...
export const fetchinstructorListData = createAction(
  '[Data] Fetch instructorlist Table Data'
);
export const fetchinstructorListSuccess = createAction(
  '[Data] Fetch instructorlist Data Success',
  props<{ instructorlist: InstructorListModel[] }>()
);
export const fetchinstructorListFailure = createAction(
  '[Data] Fetch instructorlist Data Failure',
  props<{ error: string }>()
);

// fetch instructorData
export const fetchinstructorgridData = createAction(
  '[Data] Fetch instructorgrid Table Data'
);
export const fetchinstructorgriduccess = createAction(
  '[Data] Fetch instructorgrid Data Success',
  props<{ instructorGrid: InstructorGridModel[] }>()
);
export const fetchinstructorgridFailure = createAction(
  '[Data] Fetch instructorgrid Data Failure',
  props<{ error: string }>()
);
...
export const deleteinstructorgriduccess = createAction(
