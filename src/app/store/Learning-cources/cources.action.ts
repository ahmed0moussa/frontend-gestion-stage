...
export const fetchcourcelistdata = createAction(
  '[Data] Fetch courcelist Table Data'
);
export const fetchcourcelistSuccess = createAction(
  '[Data] Fetch courcelist Data Success',
  props<{ courcelistdata: CourseDetailModel[] }>()
);
export const fetchcourcelistFailure = createAction(
  '[Data] Fetch courcelist Data Failure',
  props<{ error: string }>()
);

// fetch courcelist data
export const fetchcourcegriddata = createAction(
  '[Data] Fetch courcegrid Table Data'
);
export const fetchcourcegriduccess = createAction(
  '[Data] Fetch courcegrid Data Success',
  props<{ Griddata: GridModel[] }>()
);
export const fetchcourcegridFailure = createAction(
  '[Data] Fetch courcegrid Data Failure',
  props<{ error: string }>()
);
...
export const deletecourcegriduccess = createAction(
