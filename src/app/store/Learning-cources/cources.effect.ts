...
import {
  addcourcegridData,
  addcourcegridDataFailure,
  addcourcegridDataSuccess,
  addcourcelistData,
  addcourcelistDataFailure,
  addcourcelistDataSuccess,
  deletecourcegridData,
  deletecourcegridFailure,
  deletecourcegriduccess,
  deletecourcelistData,
  deletecourcelistFailure,
  ...
  fetchcourcelistdata,
  updatecourcegridData,
  updatecourcegridDataFailure,
  updatecourcegridDataSuccess,
  updatecourcelistData,
  updatecourcelistDataFailure,
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.CrudService.fetchData('/app/courseList').pipe(
          ...
          catchError((error) => of(fetchcourcelistFailure({ error })))
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.CrudService.fetchData('/app/courseGrid').pipe(
          map((Griddata) => fetchcourcegriduccess({ Griddata })),

          catchError((error) => of(fetchcourcegridFailure({ error })))
        )
      )
    )
  );
